...
if send == requestsValue:
    endTime = time.time()
    allTime = int(endTime - startTime)
    print(f"Работа заняла {allTime} секунд")


# TODO: Добавить количество времени потраченное на работу. Выводить в конце.
